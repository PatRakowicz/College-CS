...
int main() {
    // I added two more strings, so it works with my systems I go back and forth from.
    // everything else is the same except for brackets.
    string inputFileWindows = "M:/Livid/Desktop/Dev/College-CS/CS-280/HW3/cities.txt";
    string inputFileMacs = "../cities.txt";
