...
class classroom {
	...
	public:
		...
		classroom(int capacit, bool computers, bool chalkboards, int sq_feet);
		void print_info();
}
...
classroom::classroom(int capacity, bool computers, boo chalkboards, int sq_feet) {
	this->capacity = capacity;
	this->computers = computers;
	this->chakboards = chalkboards;
